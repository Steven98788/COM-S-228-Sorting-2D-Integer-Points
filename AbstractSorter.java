...
public abstract class AbstractSorter
{
	...
	protected AbstractSorter(Point[] pts) throws IllegalArgumentException
	{
		...
		if (pts == null) {
			throw new IllegalArgumentException("AbstractSorter's argument points were null");
		}
		
		// Second argument check
		if (pts.length == 0) {
			throw new IllegalArgumentException("AbstractSorter argument points had a length of 0");
		}
	...
	public void setComparator(int order) throws IllegalArgumentException
	{
		// TODO 
		if (order < 0 || order > 1) {
			throw new IllegalArgumentException("setComparator: Comparator order is outside the interval [0,2]");
		}
	...
	{
		int ptsLength = points.length/2;
		return points[ptsLength]; 
	}
